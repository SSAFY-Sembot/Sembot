...
const sampleDocs = [
  {
    ...
    content:
      "입사다음연도1월1일에는다음각호의연차유급휴가를준다.<신설2021.12.28.>\n 1. 15일의연차유급휴가 ...",
  },
  {
    metadata: {
...
const sampleQnAs: QnA[] = [
  {
    chatId: "1234",
    question: new BaseMessage(
      "question",
      "포탈 시스템 문의에 대해 질문이 있습니다."
    ),
    answer: new BaseMessage(
      "answer",
      "포탈 시스템 관련 정보를 제공해 드립니다."
    ),
    docs: sampleDocs,
  },
];
...
export const Default = () => {
  ...
  const feedbackReasons = ["피드백1", "피드백2"];
