...
from summarize.timer import timeit, async_timeit

from summarize.summarizer_prompts import MAP_PROMPT_TEXT, COMBINE_PROMPT_TEXT
    ...
    async def summarize(
        ...
        try:
            ...
            if isinstance(pdf_info, (str, Path)):
                ...
                text = await self._extract_text_from_upload_file(file=pdf_info, extractor=extractor)
